...
class ZehnderCard extends LitElement {
  ...
  render() {
    ...
    const name = this.config.name || "NoName";
    ...
    <ha-card>
      ...
      <div class="container">
        ...
        <div id="left">
          ...
          <div id="intake">
              <svg viewBox="0 0 212.5 180">
                <text font-size="24px" x="10" y="35">${this.hass.states['sensor.ca350_outside_temperature'].state}°C</text>
                <text font-size="24px" x="54" y="135">${this.hass.states['sensor.ca350_supply_fan_speed'].state} rpm</text>
                <g transform="translate(10, 110) scale(0.2, 0.2)">
                <svg preserveAspectRatio="xMidYMid meet" focusable="false" role="img" aria-hidden="true" viewBox="0 0 24 24" class="icon"> 
                  <g> 
          ...
          <div id="exhaust">
            <svg viewBox="0 0 212.5 180">
              <text font-size="24px" x="10" y="58">${this.hass.states['sensor.ca350_exhaust_temperature'].state}°C</text>
              <text font-size="24px" x="54" y="158">${Math.trunc(this.hass.states['sensor.ca350_exhaust_fan_speed'].state)} rpm</text>
          ...
          <div id="target_temperature">
            <svg viewBox="0 0 80 40">
              <text x="50%" dx="1" y="25%" text-anchor="middle" style="font-size:13px">
                ${this.hass.states[this.config.entity].attributes.temperature}
        ...
        <div id="right" class="right">
          ...
          <div id="return">
            <svg viewBox="0 0 212.5 180">
              <text font-size="24px" x="204.5" y="35" text-anchor="end">${this.hass.states['sensor.ca350_return_temperature'].state}°C</text>
              <text font-size="24px" x="160" y="135" text-anchor="end">${Math.trunc(this.hass.states['sensor.ca350_return_temperature'].state)}%</text>
          ...
          <div id="supply">
            <svg viewBox="0 0 212.5 180">
              <text font-size="24px" x="204.5" y="58" text-anchor="end">${this.hass.states['sensor.ca350_supply_temperature'].state}°C</text>
              <text font-size="24px" x="160" y="158" text-anchor="end">${Math.trunc(this.hass.states['sensor.ca350_supply_air_level'].state)}%</text>
  ...
  getSummerModeTmpl() {
    if (this.hass.states['binary_sensor.ca350_summer_mode'].state == 'off') {
      return html `<ha-icon icon="mdi:snowflake" style="color: var(--cyan-color);"></ha-icon>`;
    } else {
